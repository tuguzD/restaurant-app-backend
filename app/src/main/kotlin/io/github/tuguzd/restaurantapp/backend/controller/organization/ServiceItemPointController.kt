...
import io.github.tuguzd.restaurantapp.backend.service.organization.FoodServiceItemPointService
...
class ServiceItemPointController(override val service: FoodServiceItemPointService) :
    EntityController<String, ServiceItemPointData>()
